...
//            String[] filemask = new String[]{""};
//            jsonInputMeta.setFileMask(filemask);
//
//            String[] excludeFilemask = new String[]{""};
//            jsonInputMeta.setExcludeFileMask(excludeFilemask);
//
//            jsonInputMeta.getFileRequired()[0] = "N";
//            jsonInputMeta.getIncludeSubFolders()[0] = "N";
...
//            System.out.println(jsonStep.getXML());
            ...
            Write2KtrFile.write("/Users/steven/Documents/filejson2db.ktr", transMeta.getXML());
            return transMeta;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
